...
// Mailbox event types
enum MailboxEventType : int32_t { RecvComm = 1, SetRecvHandler = 2, SendComm = 3, Shutdown = 4, RemoveNeighbor = 5, AddNeighbor = 6 };
...
class MailboxEventRemoveNeighbor : public MailboxEventBase {
 public:
  MailboxEventRemoveNeighbor(int process_id, int priority) : MailboxEventBase(MailboxEventType::RemoveNeighbor, priority), process_id_(process_id) {}
  int GetProcessId() { return process_id_; }
...
class MailboxEventAddNeighbor : public MailboxEventBase {
 public:
  MailboxEventAddNeighbor(int process_id, const std::string& addr, int priority) : MailboxEventBase(MailboxEventType::AddNeighbor, priority), process_id_(process_id), addr_(addr) {}
